      ...
      if (movieObj.movie_count !== 0) {
        movieObj.movies.forEach(movieInfo => {
          ...
          <div class="movie">
            ...
            <div>
              <button id="open" class="download-btn blue-btn">Download Movie</button>
            </div>
          </div>`;
        });
          ...
          <div class="movie-details">
            ...
            <ul>
              ${movieObj.torrents.map(torrent => `
                <li>Download: <a href="${torrent.url}" class="download-link blue-btn">Quality: ${torrent.quality} | Size: ${torrent.size}</a></li>
                <li>Seeds: ${torrent.seeds} | Peers: ${torrent.peers}</li>
                <hr>
              `).join('')}
            </ul>
